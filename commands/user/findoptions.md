---
name: findoptions
description: Analyze different approaches for the given task or problem
---

## Instructions

The task/problem is: $ARGUMENTS
...
```
/findoptions Implement user authentication for our web application
```
