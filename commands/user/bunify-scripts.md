...
Search the repository for shell scripts (.sh, .bash files) and convert them to modern Bun TypeScript scripts. Place the converted scripts in a /scripts directory and properly configure them in Bun.json.
...
3. Convert shell commands to Bun TypeScript equivalents using Bun APIs
4. Create TypeScript files in /scripts directory with descriptive names
5. Add corresponding tasks to package.json for easy execution
