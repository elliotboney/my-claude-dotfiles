---
name: changelog
description: Generate comprehensive changelog from git commits, pull requests, and release tags following conventional changelog standards.
---
...
git log --since="2025-01-01" --until="2025-12-31" --pretty=format:"%h %s"
